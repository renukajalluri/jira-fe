      ...
      <div className={classes.projectDetails}>
        ...
        <div className={classes.dGrid}>
          <div className={classes.input}>
            ...
            <div>
              <p className={classes.date}>
                Start Date : {project ? project.start_date : null} | End Date :{" "}
          ...
          <div className={classes.input}>
            ...
            <input
              value={project ? project.owner.name : null}
              type="text"
              disabled
            />
          </div>
          <div className={classes.apGrid}>
            <div className={classes["assignee-priority"]}>
              ...
              <label className={classes.label} htmlFor="assignee">
                Filter Assignee
              </label>
            </div>
            <div className={classes["assignee-priority"]}>
        ...
        <div className="width-25">
          ...
          {todo.map((issue) => {
            return (
              <Link
                key={issue._id}
                href={`/dashboard/projectBoard/issueDetails/${issue._id}`}
              >
                <a>
