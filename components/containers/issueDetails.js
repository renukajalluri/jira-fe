            ...
            try{
                ...
                if(!data){
                    ...
                    if(puser.id==data.created_by._id){
                        // console.log("p",puser.id)
                        // console.log("created",data.created_by._id)
                        setCreater(true)
                    }
                    setIssue(data)
        ...
        !issue?<Backdrop open>
         ...
         <div className={classes.container}>
          ...
          <div className={classes.right}>
            ...
            {puser.job_role == "manager"?"":  <Link href={`/dashboard/projectBoard/relatedIssues/${issue._id}`}>
              <a >Related Issues</a>
              </Link>
              }
           { issue.status =="completed" ?"":  creater?<Link href={`/dashboard/projectBoard/editIssue/${issue._id}`}><a href="">Edit Issue</a></Link>:null}
