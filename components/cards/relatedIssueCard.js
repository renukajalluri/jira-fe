...
// console.log("l",issue)
// console.log("issue",issue.map(i=>i.summary))
// setSummary(issue.map(i=>i.summary))
// console.log(summary,"summ")
// setDesc(issue.map(i=>i.description))
// setStatus(issue.map(i=>i.status))
// setId(issue.map(i=>i._id))
// console.log(issue.map(i=>i.summary),"issue")
    ...
    return(
        <div>
            ...
            <div className="pad-10" >
                ...
                <div style={{color:"rgba(0, 0, 0, 0.5)",fontSize:"13px"}}>{issue.description}.</div>
            </div>
